...
I learnt a few very interesting things. Firstly, you would see that I added a `theme` to the entire file which I felt was so cool and a cleaner way to display the data. I realized we can literally us `HTML commands` and my prior knowledge helped me to incorporate some HTML code to make this report smoother. I even learnt about the `Table of Contents` which I felt is an amazing way for us to navigate in our documents. 

# Share something that you have found difficult, confusing, or haven’t figured out yet
As of now, I am planning on making a map visual which will be illustrating the vaccination distribution in the country and I have found a data set which contains all the latitudes and longitudes of all the states, but I am facing difficulties combing that data set and making a map. I will be coming in your office hours to understand the how I can do it. Another thing which I felt was a bit confusing for me was, explanation of QQ plot and a few more visuals like map visuals. What are captions suppose to give information about in our graphs?

`Below is the progress of our project as of now.`
